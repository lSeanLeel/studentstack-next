...
export const metadata: Metadata = {
  ...
  description:
    "Free daily for parents of high schoolers — how students use AI to stay organized for school. Student-led. Join with your email, or reach out for a personal reply.",
};

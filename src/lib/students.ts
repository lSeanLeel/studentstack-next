...
/** Team campuses should stay aligned with the landing rotator (plus UC Davis for Terry). */
export const students: Student[] = [
  ...
  },
  {
    ...
    bio: "I'm a CS student at UC Davis with prior experience as a Product Manager at Apple. I help high schoolers think about product, AI tools, and how to turn technical curiosity into real projects that stand out.",
    accomplishments: [
      "Product Manager at Apple",
      "Shipped consumer product features used by millions",
      "UC Davis CS peer mentor",
      "Built student-facing AI product workflows",
    ],
    initials: "TW",
  },
  {
    ...
    bio: "I'm a Neuroscience student at Berkeley on the premed track. My work involves neuro-geriatrics research at UCSF. I help students navigate the competitive premed landscape, from securing research fellowships to managing the academic rigors of a science-heavy curriculum.",
    accomplishments: [
      "Research Fellow at UCSF",
      "Co-author in Journal of Neuroscience",
      "Coca-Cola Scholar",
      "Berkeley Premed Society Board Member",
    ],
    initials: "AD",
  ...
  },
  {
    ...
    bio: "I study Physics and Machine Learning at Columbia. My background includes research at CERN and leading campus AI groups. I help students interested in the fundamental sciences and the technical implementation of AI.",
    accomplishments: [
  ...
  },
  {
    ...
    classYear: "2028",
    major: "EECS",
    bio: "I'm an EECS major at Berkeley. I've interned at Google and built AI study tools used by thousands of students. I focus on helping students develop the software engineering skills needed for both industry roles and independent product development.",
    accomplishments: [
